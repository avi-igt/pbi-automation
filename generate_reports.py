"""
generate_reports.py — Run the full FRD → Power BI report generation pipeline.

Usage:
    python generate_reports.py                         # uses FRD in current dir
    python generate_reports.py path/to/FRD.docx        # explicit FRD path
    python generate_reports.py path/to/FRD.docx -o ./output  # custom output dir
...
def print_banner():
    ...
    sep   = _c(_GRAY, "  ·  ")
    tool  = _c(_GRAY, "pbi-automation  ·  report-generator")
    print()
...
from report_generator.frd_parser import parse_frd
from report_generator.rdl_generator import generate_all_rdl
from report_generator.pbip_generator import generate_all_pbip
